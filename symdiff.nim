...
proc sym_diff1*(xs: seq[int], ys: seq[int], buf: var IntSet, max_distance: int) =
  let
    last1 = len(xs) - 1
    last2 = len(ys) - 1
  var
...
proc sum_sym_diff1*(xs0, xs1, xs2, xs3, xs4, xs5, xs6, xs7, xs8, xs9, xs10, xs11: seq[int], max_dist: int) : int =
  var
    buf2 = initIntSet()
  symdiff1(xs0, xs1, buf2, max_dist)
  if buf2.len > max_dist: return max_dist + 1
  symdiff1(xs2, xs3, buf2, max_dist)
  if buf2.len > max_dist: return max_dist + 1
  symdiff1(xs4, xs5, buf2, max_dist)
  if buf2.len > max_dist: return max_dist + 1
  symdiff1(xs6, xs7, buf2, max_dist)
  if buf2.len > max_dist: return max_dist + 1
  symdiff1(xs8, xs9, buf2, max_dist)
  if buf2.len > max_dist: return max_dist + 1
  symdiff1(xs10, xs11, buf2, max_dist)
  if buf2.len > max_dist: return max_dist + 1
  result = buf2.len
